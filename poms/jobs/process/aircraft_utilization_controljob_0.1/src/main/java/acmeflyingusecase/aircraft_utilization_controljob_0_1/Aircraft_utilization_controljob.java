...
package acmeflyingusecase.aircraft_utilization_controljob_0_1;
...
/**
 * Job: Aircraft_utilization_controljob Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Aircraft_utilization_controljob implements TalendJob {
	...
	private final String jobName = "Aircraft_utilization_controljob";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Aircraft_utilization_controljob.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Aircraft_utilization_controljob.this,
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (osName_tRunJob_1 != null && osName_tRunJob_1.toLowerCase().startsWith("win")) {
					...
					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1,
							"-Dtalend.component.manager.m2.repository=/Users/maxtico/Downloads/TOS_DI-20211109_1610-V8.0.1/configuration/.m2/repository");

					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1, "-cp");

					String classpath_tRunJob_1_7 = "/Users/maxtico/Documents/Master%20Data%20Science/DW/PROJECT/ACMEFLYINGUSECASE/poms/jobs/process/aircraftutilization_0.1/target/classes;/Users/maxtico/Documents/Master%20Data%20Science/DW/PROJECT/ACMEFLYINGUSECASE/poms/jobs/process/aircraftutilization_0.1/src/main/ext-resources;/Users/maxtico/Documents/Master%20Data%20Science/DW/PROJECT/ACMEFLYINGUSECASE/poms/code/routines/target/classes;.;/Users/maxtico/Downloads/TOS_DI-20211109_1610-V8.0.1/configuration/.m2/repository/org/apache/logging/log4j/log4j-slf4j-impl/2.13.2/log4j-slf4j-impl-2.13.2.jar;/Users/maxtico/Downloads/TOS_DI-20211109_1610-V8.0.1/configuration/.m2/repository/org/apache/logging/log4j/log4j-api/2.13.2/log4j-api-2.13.2.jar;/Users/maxtico/Downloads/TOS_DI-20211109_1610-V8.0.1/configuration/.m2/repository/org/apache/logging/log4j/log4j-core/2.13.2/log4j-core-2.13.2.jar;/Users/maxtico/Downloads/TOS_DI-20211109_1610-V8.0.1/configuration/.m2/repository/com/oracle/ojdbc/ojdbc8/19.3.0.0/ojdbc8-19.3.0.0.jar;/Users/maxtico/Downloads/TOS_DI-20211109_1610-V8.0.1/configuration/.m2/repository/org/jboss/marshalling/jboss-marshalling/2.0.12.Final/jboss-marshalling-2.0.12.Final.jar;/Users/maxtico/Downloads/TOS_DI-20211109_1610-V8.0.1/configuration/.m2/repository/org/dom4j/dom4j/2.1.3/dom4j-2.1.3.jar;/Users/maxtico/Downloads/TOS_DI-20211109_1610-V8.0.1/configuration/.m2/repository/org/talend/libraries/talend-oracle-timestamptz/6.0.0/talend-oracle-timestamptz-6.0.0.jar;/Users/maxtico/Downloads/TOS_DI-20211109_1610-V8.0.1/configuration/.m2/repository/org/slf4j/slf4j-api/1.7.29/slf4j-api-1.7.29.jar;/Users/maxtico/Downloads/TOS_DI-20211109_1610-V8.0.1/configuration/.m2/repository/org/postgresql/postgresql/42.2.14/postgresql-42.2.14.jar;/Users/maxtico/Downloads/TOS_DI-20211109_1610-V8.0.1/configuration/.m2/repository/org/talend/daikon/crypto-utils/0.31.12/crypto-utils-0.31.12.jar;";

					if (audit_jar_path_tRunJob_1 != null && !audit_jar_path_tRunJob_1.isEmpty()) {
						classpath_tRunJob_1_7 += audit_jar_path_tRunJob_1;
					}

					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1,
							dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(classpath_tRunJob_1_7), true);

					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1,
							"acmeflyingusecase.aircraftutilization_0_1.AircraftUtilization");
					...
					String classpath_tRunJob_1_7 = "/Users/maxtico/Documents/Master Data Science/DW/PROJECT/ACMEFLYINGUSECASE/poms/jobs/process/aircraftutilization_0.1/target/classpath.jar:";
					...
					jvm_argument_helper_tRunJob_1.addArgumentsTo(paraList_tRunJob_1,
							dealChildJobLibrary_tRunJob_1.replaceJarPathsFromCrcMap(classpath_tRunJob_1_7)
	...
	public static void main(String[] args) {
		final Aircraft_utilization_controljob Aircraft_utilization_controljobClass = new Aircraft_utilization_controljob();

		int exitCode = Aircraft_utilization_controljobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Aircraft_utilization_controljob.class.getClassLoader().getResourceAsStream(
					"acmeflyingusecase/aircraft_utilization_controljob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Aircraft_utilization_controljob.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Aircraft_utilization_controljob");
		}
...
/************************************************************************************************
 * 42829 characters generated by Talend Open Studio for Data Integration on the
 * December 11, 2023, 2:56:52 PM CET
 ************************************************************************************************/